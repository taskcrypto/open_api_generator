...
class WalletOptionSuccess with _$WalletOptionSuccess {
  const factory WalletOptionSuccess({
    @JsonKey(name: 'OptionBuyTradeLimit') required double optionBuyTradeLimit,
    @JsonKey(name: 'OptionSellTradeLimit') required double optionSellTradeLimit,
    @JsonKey(name: 'MarginRequirement') required double marginRequirement,
