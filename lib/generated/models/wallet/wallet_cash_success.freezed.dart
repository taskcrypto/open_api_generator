...
mixin _$WalletCashSuccess {
  ...
  /// Serializes this WalletCashSuccess to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of WalletCashSuccess
...
class _$WalletCashSuccessImpl implements _WalletCashSuccess {
  const _$WalletCashSuccessImpl(
      {@JsonKey(name: 'StockAccountWallet') required this.stockAccountWallet,
      @JsonKey(name: 'AuKCStockAccountWallet')
      required this.auKCStockAccountWallet,
      @JsonKey(name: 'AuJbnStockAccountWallet')
      required this.auJbnStockAccountWallet});
...
abstract class _WalletCashSuccess implements WalletCashSuccess {
  const factory _WalletCashSuccess(
          {@JsonKey(name: 'StockAccountWallet')
          required final double? stockAccountWallet,
          @JsonKey(name: 'AuKCStockAccountWallet')
          required final double? auKCStockAccountWallet,
          @JsonKey(name: 'AuJbnStockAccountWallet')
          required final double? auJbnStockAccountWallet}) =
