...
mixin _$WalletFutureSuccess {
  ...
  /// Serializes this WalletFutureSuccess to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of WalletFutureSuccess
...
class _$WalletFutureSuccessImpl implements _WalletFutureSuccess {
  const _$WalletFutureSuccessImpl(
      {@JsonKey(name: 'FutureTradeLimit') required this.futureTradeLimit,
      @JsonKey(name: 'MarginRequirement') required this.marginRequirement,
      @JsonKey(name: 'MarginRequirementSell')
      required this.marginRequirementSell});
...
abstract class _WalletFutureSuccess implements WalletFutureSuccess {
  const factory _WalletFutureSuccess(
          {@JsonKey(name: 'FutureTradeLimit')
          required final double? futureTradeLimit,
          @JsonKey(name: 'MarginRequirement')
          required final double? marginRequirement,
          @JsonKey(name: 'MarginRequirementSell')
          required final double? marginRequirementSell}) =
