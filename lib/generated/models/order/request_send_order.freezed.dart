...
mixin _$RequestSendOrder {
  ...
  List<Positions>? get closePositions => throw _privateConstructorUsedError;
...
class _$RequestSendOrderImpl implements _RequestSendOrder {
  const _$RequestSendOrderImpl(
      ...
      @JsonKey(name: 'ClosePositions') final List<Positions>? closePositions,
  ...
  final List<Positions>? _closePositions;
  @override
  @JsonKey(name: 'ClosePositions')
  List<Positions>? get closePositions {
