...
class BoardSuccess with _$BoardSuccess {
  const factory BoardSuccess({
    ...
    required String? bidSign,
    @JsonKey(name: 'MarketOrderSellQty')
    required double? marketOrderSellQty,
    @JsonKey(name: 'Sell1')
    required Map<String, dynamic>? sell1,
    @JsonKey(name: 'Sell2')
    required Map<String, dynamic>? sell2,
    @JsonKey(name: 'Sell3')
    required Map<String, dynamic>? sell3,
    @JsonKey(name: 'Sell4')
    required Map<String, dynamic>? sell4,
    @JsonKey(name: 'Sell5')
    required Map<String, dynamic>? sell5,
    @JsonKey(name: 'Sell6')
    required Map<String, dynamic>? sell6,
    @JsonKey(name: 'Sell7')
    required Map<String, dynamic>? sell7,
    @JsonKey(name: 'Sell8')
    required Map<String, dynamic>? sell8,
    @JsonKey(name: 'Sell9')
    required Map<String, dynamic>? sell9,
    @JsonKey(name: 'Sell10')
    required Map<String, dynamic>? sell10,
    @JsonKey(name: 'AskQty')
    ...
    required String? askSign,
    @JsonKey(name: 'MarketOrderBuyQty')
    required double? marketOrderBuyQty,
    @JsonKey(name: 'Buy1')
    required Map<String, dynamic>? buy1,
    @JsonKey(name: 'Buy2')
    required Map<String, dynamic>? buy2,
    @JsonKey(name: 'Buy3')
    required Map<String, dynamic>? buy3,
    @JsonKey(name: 'Buy4')
    required Map<String, dynamic>? buy4,
    @JsonKey(name: 'Buy5')
    required Map<String, dynamic>? buy5,
    @JsonKey(name: 'Buy6')
    required Map<String, dynamic>? buy6,
    @JsonKey(name: 'Buy7')
    required Map<String, dynamic>? buy7,
    @JsonKey(name: 'Buy8')
    required Map<String, dynamic>? buy8,
    @JsonKey(name: 'Buy9')
    required Map<String, dynamic>? buy9,
    @JsonKey(name: 'Buy10')
    required Map<String, dynamic>? buy10,
    @JsonKey(name: 'OverSellQty')
    required double? overSellQty,
    @JsonKey(name: 'UnderBuyQty')
    required double? underBuyQty,
    @JsonKey(name: 'TotalMarketValue')
    required double? totalMarketValue,
    @JsonKey(name: 'ClearingPrice')
    required double? clearingPrice,
    @JsonKey(name: 'IV')
    required double? iV,
    @JsonKey(name: 'Gamma')
