...
mixin _$ApiSoftLimitResponse {
  ...
  /// Serializes this ApiSoftLimitResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ApiSoftLimitResponse
...
class _$ApiSoftLimitResponseImpl implements _ApiSoftLimitResponse {
  const _$ApiSoftLimitResponseImpl(
      ...
      @JsonKey(name: 'Margin') required this.margin,
      @JsonKey(name: 'Future') required this.future,
      @JsonKey(name: 'FutureMini') required this.futureMini,
      @JsonKey(name: 'FutureMicro') required this.futureMicro,
      @JsonKey(name: 'Option') required this.option,
      @JsonKey(name: 'MiniOption') required this.miniOption,
      @JsonKey(name: 'KabuSVersion') required this.kabuSVersion});
...
abstract class _ApiSoftLimitResponse implements ApiSoftLimitResponse {
  const factory _ApiSoftLimitResponse(
          ...
          @JsonKey(name: 'Margin') required final double? margin,
          @JsonKey(name: 'Future') required final double? future,
          @JsonKey(name: 'FutureMini') required final double? futureMini,
          @JsonKey(name: 'FutureMicro') required final double? futureMicro,
          @JsonKey(name: 'Option') required final double? option,
          @JsonKey(name: 'MiniOption') required final double? miniOption,
          @JsonKey(name: 'KabuSVersion') required final String? kabuSVersion}) =
