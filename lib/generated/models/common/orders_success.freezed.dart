...
mixin _$OrdersSuccess {
  ...
  /// Serializes this OrdersSuccess to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of OrdersSuccess
...
class _$OrdersSuccessImpl implements _OrdersSuccess {
  const _$OrdersSuccessImpl(
      ...
      @JsonKey(name: 'OrderState') required this.orderState,
      @JsonKey(name: 'OrdType') required this.ordType,
      @JsonKey(name: 'RecvTime') required this.recvTime,
      ...
      @JsonKey(name: 'OrderQty') required this.orderQty,
      @JsonKey(name: 'CumQty') required this.cumQty,
      ...
      @JsonKey(name: 'MarginPremium') required this.marginPremium,
      @JsonKey(name: 'Details')
...
abstract class _OrdersSuccess implements OrdersSuccess {
  const factory _OrdersSuccess(
          ...
          @JsonKey(name: 'OrderState') required final int? orderState,
          @JsonKey(name: 'OrdType') required final int? ordType,
          @JsonKey(name: 'RecvTime') required final String? recvTime,
          ...
          @JsonKey(name: 'OrderQty') required final double? orderQty,
          @JsonKey(name: 'CumQty') required final double? cumQty,
          ...
          @JsonKey(name: 'MarginPremium') required final double? marginPremium,
          @JsonKey(name: 'Details')
          required final List<Map<String, dynamic>>? details}) =
      _$OrdersSuccessImpl;
