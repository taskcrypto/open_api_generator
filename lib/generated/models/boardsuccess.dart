...
part 'boardsuccess.freezed.dart';
...
class BoardSuccess with _$BoardSuccess {
  const factory BoardSuccess({
    ...
    double? marketOrderSellQty,
    @JsonKey(name: 'Sell1')
    Map<String, dynamic>? sell1,
    @JsonKey(name: 'Sell2')
    Map<String, dynamic>? sell2,
    @JsonKey(name: 'Sell3')
    Map<String, dynamic>? sell3,
    @JsonKey(name: 'Sell4')
    Map<String, dynamic>? sell4,
    @JsonKey(name: 'Sell5')
    Map<String, dynamic>? sell5,
    @JsonKey(name: 'Sell6')
    Map<String, dynamic>? sell6,
    @JsonKey(name: 'Sell7')
    Map<String, dynamic>? sell7,
    @JsonKey(name: 'Sell8')
    Map<String, dynamic>? sell8,
    @JsonKey(name: 'Sell9')
    Map<String, dynamic>? sell9,
    @JsonKey(name: 'Sell10')
    Map<String, dynamic>? sell10,
    @JsonKey(name: 'AskQty')
    double? askQty,
    ...
    double? marketOrderBuyQty,
    @JsonKey(name: 'Buy1')
    Map<String, dynamic>? buy1,
    @JsonKey(name: 'Buy2')
    Map<String, dynamic>? buy2,
    @JsonKey(name: 'Buy3')
    Map<String, dynamic>? buy3,
    @JsonKey(name: 'Buy4')
    Map<String, dynamic>? buy4,
    @JsonKey(name: 'Buy5')
    Map<String, dynamic>? buy5,
    @JsonKey(name: 'Buy6')
    Map<String, dynamic>? buy6,
    @JsonKey(name: 'Buy7')
    Map<String, dynamic>? buy7,
    @JsonKey(name: 'Buy8')
    Map<String, dynamic>? buy8,
    @JsonKey(name: 'Buy9')
    Map<String, dynamic>? buy9,
    @JsonKey(name: 'Buy10')
    Map<String, dynamic>? buy10,
